...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
	...
	<xsl:template match="gmd:MD_Metadata">
		<xsl:copy>
            ...
            <!-- Set braces around UUID according to NGMP if needed -->
			<gmd:fileIdentifier>
                <xsl:choose>
                    <xsl:when test="starts-with(/root/env/uuid, '{')">
